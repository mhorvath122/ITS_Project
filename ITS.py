...
path = "/home/hma/Dokumentumok/ITS_Project/myData" # folder with all the class folders
labelFile = '/home/hma/Dokumentumok/ITS_Project/labels.csv' # file with all names of classes
...
def myModel():
    no_Of_Filters=100
    size_of_Filter=(2,2) # THIS IS THE KERNEL THAT MOVE AROUND THE IMAGE TO GET THE FEATURES.
                         # THIS WOULD REMOVE 2 PIXELS FROM EACH BORDER WHEN USING 32 32 IMAGE
    size_of_Filter2=(2,2)
    size_of_pool=(2,2)  # SCALE DOWN ALL FEATURE MAP TO GERNALIZE MORE, TO REDUCE OVERFITTING
    no_Of_Nodes = 100000   # NO. OF NODES IN HIDDEN LAYERS
    model= Sequential()
...
pickle_out= open("sixIII.p","wb")  # wb = WRITE BYTE
